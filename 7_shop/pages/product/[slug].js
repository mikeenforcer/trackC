    ...
    <section class="text-gray-600 body-font overflow-hidden">
      <div class="container px-5 py-16 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto object-cover  rounded px-24" src=" https://m.media-amazon.com/images/I/61r0PYFOONL._UL1500_.jpg" />
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 class="text-sm title-font text-gray-500 tracking-widest"> CODESWEAR</h2>
            <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Wear the code(XL/Blue)</h1>
            <div class="flex mb-4">
            ...
            <div class="flex">
              ...
              <button class="flex ml-8 text-white bg-pink-500 border-0 py-2 md:px-6 px-2 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
              <button onClick={()=>{addToCart(slug,1,499,"Wear the code(XL,RED)","XL","Red")}} class="flex ml-4 text-white bg-pink-500 border-0 py-2 md:px-6 px-2 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
            ...
            <div className="pin mt-6 space-x-2 text-sm flex">
              ...
              <button  onClick={checkServiceability} className="flex ml-12 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Check </button>
            </div>
            {
